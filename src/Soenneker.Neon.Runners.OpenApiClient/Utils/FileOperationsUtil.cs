...
using Soenneker.Neon.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Neon.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Neon:ClientGenerationUrl"] ?? "https://neon.com/api_spec/release/v2.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "NeonOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
